...
--------------------------------|---------------------------------------------
`define `[`da_cap`](#da_8h_1aef9885cf29028c16e56abd0e564d7eca)            | Returns the capacity of the given array.
`define `[`da_len`](#da_8h_1a303efb267601c14b434ceb359bc11f78)            | Returns the length of the given array.
`define `[`da_maxlen`](#da_8h_1ae7f65059a1c47bd7919050921e16a078)            | Returns the maximum length of the given array.
`define `[`da_ismutable`](#da_8h_1a973206acf4ca812a3d2961d029e3e750)            | Returns non-zero if the given array is mutable.
...
`public `[`da_t`](#structda__t)` * `[`da_new`](#da_8h_1ab82eb7d0c86d0419a064156ce19b6209)`(const `[`da_spec_t`](#structda__spec__t)` * spec)`            | Allocates and initializes a new `[da_t](#structda__t)` with the given `spec` and returns it. The returned value must be freed to avoid memory leaks.
`public void `[`da_init`](#da_8h_1a3bc848cb251221263beddae77eca92df)`(`[`da_t`](#structda__t)` * da,const `[`da_spec_t`](#structda__spec__t)` * spec)`            | Initialize a previously allocated `da` with the given `spec`.
...
`struct `[`da_spec_t`](#structda__spec__t) | `[da_spec_t](#structda__spec__t)` defines the type of element contained by the dynamic array. Every `[da_t](#structda__t)` must contain a reference to a `[da_spec_t](#structda__spec__t)`. A spec can and should be defined once for each type and reused for every dynamic array that handles the type it described.
`struct `[`da_t`](#structda__t) | `[da_t](#structda__t)` is the dynamic array type.
...
#### `public `[`da_t`](#structda__t)` * `[`da_new`](#da_8h_1ab82eb7d0c86d0419a064156ce19b6209)`(const `[`da_spec_t`](#structda__spec__t)` * spec)` 

Allocates and initializes a new `[da_t](#structda__t)` with the given `spec` and returns it. The returned value must be freed to avoid memory leaks.

#### `public void `[`da_init`](#da_8h_1a3bc848cb251221263beddae77eca92df)`(`[`da_t`](#structda__t)` * da,const `[`da_spec_t`](#structda__spec__t)` * spec)` 
...
`[da_spec_t](#structda__spec__t)` defines the type of element contained by the dynamic array. Every `[da_t](#structda__t)` must contain a reference to a `[da_spec_t](#structda__spec__t)`. A spec can and should be defined once for each type and reused for every dynamic array that handles the type it described.

## Summary

 Members                        | Descriptions                                
--------------------------------|---------------------------------------------
`public size_t `[`size`](#structda__spec__t_1a27302589ecc07aafc57e78ce06e6fe71) | REQUIRED
`public `[`da_init_func_t`](#da_8h_1aeb9ffe97105529004ae5795eac0c8d97)` * `[`init`](#structda__spec__t_1a771aa7be8acdd60e70ca7b33ed7c15ca) | OPTIONAL
`public `[`da_copy_func_t`](#da_8h_1a41114256ec2e29681ded73c370895177)` * `[`copy`](#structda__spec__t_1a14c7d65ccdf57f84c652351767b64275) | OPTIONAL
...
A pointer to a function that takes two pointers to the type defined this spec and copies the second into the first.

#### `public `[`da_free_func_t`](#da_8h_1a62cdc9fe47fa1cb2f0a8d4b8dc12b780)` * `[`free`](#structda__spec__t_1a6555f056601e7e85ed0a928eb1b654a2) 

# struct `da_t` 

`[da_t](#structda__t)` is the dynamic array type.
